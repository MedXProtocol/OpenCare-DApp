import { all, fork, setContext, takeEvery } from 'redux-saga/effects'
...
import { mixpanelOrMock } from '~/services/mixpanelService'

export default function* () {
  yield setContext({ mixpanel: mixpanelOrMock })
