...
export const jicCompressImage = {
  ...
  compress: function(source_img_obj, quality, output_format, scale) {
    ...
    if (scale) {
      console.log("scaling dimensions by: " + scale * 100 + "%");
      canvasWidth = scale * source_img_obj.naturalWidth;
      canvasHeight = scale * source_img_obj.naturalHeight;
