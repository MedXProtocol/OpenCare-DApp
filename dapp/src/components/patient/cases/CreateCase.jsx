                ...
                <div className="row">
                  <div className="col-xs-12 col-md-12">
                    ...
                    <p className="text-gray">
                      All information is encrypted and visible to only you and the dermatologist. By submitting a case on EyeX, you agree to the terms in our disclaimer: <a onClick={(e) => this.setState({ showDisclaimerModal: true })}>Read Disclaimer</a>
                    </p>
                  </div>
                </div>
              </div>
